...
public abstract class BooksDatabase extends RoomDatabase {
    ...
    private static class InitialDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            book7.setUnitPrice("$250");
            book7.setCategoryId(2);
            Book book8 = new Book();
            book8.setBookName("A Hound of the New York");
            book8.setUnitPrice("$13.00");
            book8.setCategoryId(2);
            Book book9 = new Book();
            book9.setBookName("Adventure of Joe Finn");
            book9.setUnitPrice("$16.99");
            ...
            book12.setBookName("Top 9myths abut UFOs");
            book12.setUnitPrice("$789");
            book12.setCategoryId(3);
            Book book13 = new Book();
            book13.setBookName("Story of a joker");
            book13.setUnitPrice("$13");
            book13.setCategoryId(3);
            Book book14 = new Book();
            book14.setBookName("Notes of a alien life cycle researcher");
            book14.setUnitPrice("$1320");
